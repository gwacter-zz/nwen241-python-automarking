...
def extract_marks(studentdir):
    ...
    m2 = re.search("CORRECTNESS MARK = (.+)",minfo)
    if m2:
       print(m2.group(1) + ",",end="")
    else:
        print("null", end="")
        
    m3 = re.search("CODE STYLE MARK = (.+)",minfo)
    m4 = re.search("CODE STYLE MARK (.+)",minfo)
    if m3:
        print(m3.group(1))
    elif m4:
        print(m4.group(1))
...
if __name__ == "__main__":
    ...
    submitdir = '/vol/submit/nwen241_2015T1/Assignment_1'
